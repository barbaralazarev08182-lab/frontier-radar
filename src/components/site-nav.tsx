      ...
      <header className="fixed inset-x-0 top-0 z-[120] h-12 border-b border-black/[0.11] bg-[#f1eee5] text-[#111214]">
        <div className="flex h-full w-full items-center justify-between gap-6 px-8 lg:px-10">
          <div className="flex min-w-0 items-center gap-5">
            <Link href="/today" className="group flex min-w-0 items-center gap-2.5" aria-label="Frontier Radar Today">
    ...
    >
      <div
        className={[
          ...
          project ? "min-h-0 pt-4" : "min-h-14 py-2.5",
        ].join(" ")}
      >
        <Link
          href="/today"
                ...
                {exploreEntry && !active ? (
                  <span
                    className={[
                      ...
                      project ? "bg-[#3150ff]" : lightEditorial ? "bg-[#3150ff]" : "bg-cyan-300",
                    ].join(" ")}
                    aria-hidden
                  />
                ) : null}
